...
Auto-generated by generate_docs.crush by introspecting the running binary's own namespace. 171 commands, 6 members skipped.
...
# Examples
    ...
    lines big_log_file.txt | sample 5
...
## global:stream:seq
    ...
    stream:seq [from=integer] [to=integer] [step=integer]

Return a stream of sequential numbers

This command accepts the following arguments:

* `from` (default: `0`) the first number in the sequence.
