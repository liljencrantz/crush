...
Auto-generated by generate_docs.crush by introspecting the running binary's own namespace. 179 commands, 6 members skipped.
...
## global:crush:warn
    ...
    crush:warn message=string

Report a warning to the bounded log crush:warnings keeps.
...
# Examples
    ...
    crush:warn "something looked off, continuing anyway"

---


## global:crush:warning_limit:get

    crush:warning_limit:get

Get how many warnings crush:warnings keeps before evicting the oldest.
...
## global:crush:warning_limit:set

    crush:warning_limit:set limit=integer

Set how many warnings crush:warnings keeps before evicting the oldest.
...
most recent warnings are kept here; in interactive mode, they are also
printed as soon as they happen.
...
warning (see `crush:warnings`) naming the host and the underlying error. pexec's
...
reported via `crush:warnings` rather than aborting `tee` or the other branches.
